            ...
            <div className="flex-row justify-center">
                <div className="bg-gray-800 p-8 rounded-2xl shadow-xl w-96">
                    ...
                    <div className="mt-2 flex flex-row justify-center">
                        <Link
                            to="/login"
                            className="hover:bg-white hover:shadow-inner hover:text-black hover:scale-110 hover:border-2 border-blue-300 hover:outline-amber-50 bg-blue-600 text-white font-semibold py-2 px-2 rounded-lg transition m-auto mt-2 "
                        >
                            login instead
                        </Link>
                    </div>
