...
const adviceData = [
    {
        ...
        description:
            'Consider allocating your investments across different asset classes to reduce risk.',
        icon: (
            <svg
    ...
    },
    {
        ...
        description:
            'Aim to have 6-9 months of expenses saved in a liquid emergency fund.',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
    ...
    },
    {
        ...
        description:
            'Optimize your investments for tax efficiency by utilizing tax-advantaged accounts.',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
    ...
    return (
        <div className="flex min-h-screen bg-black border-2">
            ...
            <div className="flex flex-1 flex-col items-center bg-black/90 py-3">
                ...
                {/* Header */}
                <header
                    className="sticky top-0 z-30 flex w-[95%] h-16  items-center justify-center gap-4  rounded-2xl px-6 mt-6
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                <p className="text-white">
                                    Welcome back, John. Here's an overview of
                                    your investments.
                                </p>
                            </div>
                            <div className="flex items-center gap-2">
                        ...
                        <div className="space-y-4 p-5 border-2 border-white rounded-2xl">
                            ...
                            {activeTab === 'allocation' && (
                                <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                                    ...
                                    <div className="pt-4">
                                        <p>
                                            Allocation content will be displayed
                                            here.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {activeTab === 'history' && (
                                <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                                    ...
                                    <div className="pt-4">
                                        <p>
                                            History content will be displayed
                                            here.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                                {adviceData.map((advice, index) => (
                                    <div
                                        key={index}
                                        className="glassmorphism-card overflow-hidden shadow-lg"
                                    >
